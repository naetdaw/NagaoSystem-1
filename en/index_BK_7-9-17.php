...
_________________________________________________________ -->
                    ...
                    <div class="row portfolio">
                        ...
                        <div class="col-sm-4">
                            <div class="box-image">
                                <div class="image">
                                    ...
                                    style="width: 350px;height: 250px; background-color: #FFFAFA;
                            ...
                            height: 200px;">
                                ...
                                <div class="bg"></div>
                                <div class="name">
                                    <h3><a href="product_3DMbrochureE.php">3D-210-D2</a></h3> 
                                </div>
                                <div class="text">
                                    <p class="buttons">
                                        <a href="product_3DMbrochureE.php" class="btn btn-template-transparent-primary">View</a>
                                        <a href="product_3DMbrochureE.php" class="btn btn-template-transparent-primary">Website</a>
                                    </p>
                                </div>
                            </div>
                            <!-- /.box-image -->
                        ...
                        <div class="col-sm-4">
                            ...
                            height: 200px;">
                                ...
                                <div class="bg"></div>
                                <div class="name">
                                    <h3><a href="product_3D80.php">3D-80</a></h3> 
                                </div>
                                <div class="text">
                                    <p class="buttons">
                                        <a href="product_3D80.php" class="btn btn-template-transparent-primary">View</a>
                                        <a href="product_3D80.php" class="btn btn-template-transparent-primary">Website</a>
                                    </p>
                                </div>
                            </div>
                            <!-- /.box-image -->
                        ...
                        <div class="col-sm-4">
                            ...
                            height: 200px;">
                                ...
                                <div class="bg"></div>
                                <div class="name">
                                    <h3><a href="product_3DB80.php">3DB-80</a></h3> 
                                </div>
                                <div class="text">
                                    <p class="buttons">
                                        <a href="product_3DB80.php" class="btn btn-template-transparent-primary">View</a>
                                        <a href="product_3DB80.php" class="btn btn-template-transparent-primary">Website</a>
                                    </p>
                                </div>
                            </div>
                            <!-- /.box-image -->
                        ...
                        <div class="col-sm-4">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/product/12345.gif" alt="" class="img-responsive"
                                    style="width: 350px;height: 250px; background-color: #FFFAFA;
                            text-align: center; border-radius: 20px;
                            border: 3px solid #BEBEBE;
                            padding: 5px; 
                            ...
                            height: 200px;">
                                ...
                                <div class="bg"></div>
                                <div class="name">
                                    <h3><a href="product_Mini2F.php">PLANET-Mini(-F)
                                    </a></h3> 
                                </div>
                                <div class="text">
                                    <p class="buttons">
                                        <a href="product_Mini2F.php" class="btn btn-template-transparent-primary">View</a>
                                        <a href="product_Mini2F.php" class="btn btn-template-transparent-primary">Website</a>
                                    </p>
                                </div>
                            </div>
                            <!-- /.box-image -->
                        ...
                        <div class="col-sm-4">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/product/planet.gif" alt="" class="img-responsive"
                                    style="width: 350px;height: 250px; background-color: #FFFAFA;
                            text-align: center; border-radius: 20px;
                            border: 3px solid #BEBEBE;
                            padding: 5px; 
                            ...
                            height: 200px;">
                                ...
                                <div class="bg"></div>
                                <div class="name">
                                    <h3><a href="product_PlanetM2_3F.php">PLANET M2-3F
                                    </a></h3> 
                                </div>
                                <div class="text">
                                    <p class="buttons">
                                        <a href="product_PlanetM2_3F.php" class="btn btn-template-transparent-primary">View</a>
                                        <a href="product_PlanetM2_3F.php" class="btn btn-template-transparent-primary">Website</a>
                                    </p>
                                </div>
                            </div>
                            <!-- /.box-image -->
    ...
    <div class="row" style="text-align: center;padding-left: 22px;">
        ...
        <h2 style="text-shadow: 0px 1px 2px #bbb;">More About Nagao System</h2>

            <div class="col-xs-6 col-sm-3 col-md-3 part" style="background-color:white;">
                <a href="service_product.php">
                    <img src="img/product/1.jpg" alt="" width="100%" />
                    <div class="text">
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 part" style="background-color: #FFDEAD;">
                <a href="profile.php">
                    <img src="img/profile/1.jpg" alt="About Us" width="100%" />
                    <div class="text">
                    <h3>About Us</h3>
                    </div>
                    <ul style="text-align: left;background-color: white;">
                        ...
                        <li><a href="coporate.php">Coporate Philosophy</a></li>
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 part" style="background-color: #E6E6FA; ">
                <a href="exhibitionE.php">
                    <img src="img/news/1.jpg" alt="newspaper" width="100%" />
                    <div class="text">
                    <h3>News</h3>
                    </div>
                    <ul style="text-align: left;background-color: white;">
            ...
            <div class="col-xs-5 col-sm-3 col-md-3 part" style="background-color: #FFDAB9;">
                <a href="achievement.php">
                    <img src="img/profile/2.jpg" alt="Partner" width="100%" />
                    <div class="text">
                    <h3>Partner</h3>
                    </div>
                </a>
