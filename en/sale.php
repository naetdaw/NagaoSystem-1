...
_________________________________________________________ -->
        ...
        <div id="heading-breadcrumbs">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h4>Sale structure & Coporate philosophy</h4>
                    </div>
                    <div class="col-md-5">
                        <ul class="breadcrumb">
                            <li><a href="index_en.php">Home</a>
                            </li>
                            <li>Sale structure & Coporate philosophy</li>
                        </ul>
 ...
 _________________________________________________________ -->
                        ...
                        <div class="panel panel-default sidebar-menu with-icons">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                   ...
                                   <li class="active"><a href="sale.php">Sales Structure</a></li>
                                  <li><a href="access1.php">Access</a></li>
                                   <li><a href="recruit.php">Careers</a></li>
                                   <li><a href="http://www4.plala.or.jp/nagaosystem/indexE.html" target="_blank"><img src="img/profile/send.png" alt="" style="width: 32px; height: 40px;"> </a> </li>  
                    ...
                    <section>
                        ...
                        <!-- /.row -->
                            ...
                            <h4>&nbsp;&nbsp;&nbsp;[Sales system of 3D Ball Mill(3D Reactor), Tilted Rotation Planetary Ball Mill<br>&nbsp;&nbsp;&nbsp;( Planet series)]</h4>
                            ...
                            <div class="row">
                            <div class="col-md-9" style="border:1.5px solid #BEBEBE;box-shadow: 5px 0px 40px rgba(0,0,0, .2); padding-top: 8px;" >
                          <p style="font-size:1.2em;">After the launch of the Tilted Rotaion Planetary Ball Mill (Planet series), more than 10 years have passed.And also 3D ball mill(3D Reactor) and sales also joined.
                            Our company focuses on direct sales organization, we are keeping detailed sales, service and after-sales service.</p>
                                        
                            <p style="font-size:1.2em;">If you are interested in products of Tilted Rotaion Planetary Ball Mill (Planet series) <br>・ 3D Ball Mill (3D Reactor)series or are considering purchasing, please come to the Nagao System INC. exhibition room and use our products together with technical personnel Actually carrying out experiments such as crushing, mechanochemical, 
                            mechanical alloying etc.<br> We would be pleased if you could get the goods.</p>
                                            
                            <p style="font-size:1.2em;">Those who can not come to the exhibition room in the distance can also send a small sample to us and test them such as crushing, kneading, mixing, dispersing, mechanochemical, mechanical alloying, amorphous etc.&nbsp;We are waiting for inquiries such as estimate and consultation (technical consultation) etc.
                            We do not have any equipment free lending, business trip runing etc.&nbsp;Also, if you are passing through a distributor, please ask the distributor to estimate.
                            </p>
                            <hr>
                             <p style="font-size: 1.4em;"><b>&nbsp;Encounters with unknown world 3D processing(milling) of materials</b></p>
                            <p style="font-size:1.2em; ">The novel & original Ball Mill with Three-Dimensional(3D) motion provides unknown possibilities on ultra-fine pulverization(Nano-scale crushing) and new materials synthesis by mechano-chemical reaction/mechanical alloying.<br>
                            The 3D motion provides also pseudo microgravity and can be applied biological/medical science fields, as well as foodstuffs and pharmaceuticals.</p>
