...
_________________________________________________________ -->
        ...
        <div id="heading-breadcrumbs">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h1>Container cleaning method</h1>
                    </div>
                    <div class="col-md-5">
                        <ul class="breadcrumb">
                            <li><a href="index_en.php">Home</a>
                            </li>
                            <li>Container cleaning method</li>
                        </ul>
 ...
 _________________________________________________________ -->
                           ...
                           <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li class="active"><a href="cleaning.php">Cleaning Method</a>
                                    </li>
                                    <li><a href="urban.php">Urban Mine</a>
                                    </li>
                                    <li><a href="decontamination.php">Decontamination</a>
                 ...
                 <div id="text-page">
                        ...
                        <!-- /.row -->
                       <h4>&nbsp;Ceramic container, cleaning method of ceramic ball</h4>
                        ...
                        <div class="col-md-12" style="border:1.5px solid #BEBEBE;box-shadow: 5px 0px 40px rgba(0,0,0, .2);" >
                                ...
                                ★1★&nbsp; Rinse balls and containers once with water</p>
                                <p style="width:658px; font-size: 1.2em;">
                              ★2★&nbsp; Place the grinding ball you used in a container, put in a small amount of spoonful of silica and alumina powder and water to the vicinity of the hook of the ball.</p>
                               <p style="width:658px; font-size: 1.2em;">
                             ★3★&nbsp; Operate Tilted Rotation Planetary Ball Mill (Planet) at medium to high speed for about 5 to 10 minutes.</p>
                              <p style="width:600px; font-size: 1.2em;">
                              ★4★&nbsp; If the dirt still does not run out, do the same work many times.</p>
                              <p style="width:600px; font-size: 1.2em;">
                              ★5★&nbsp; Or you can bake it with acid.</p>
                             <br>
                              <p style="font-size: 1.2em; text-align: center;">★★&nbsp;<b>Cleaning of 3-dimensional ball mill(3D Reactor) containers as well</b>&nbsp;★★</p>
