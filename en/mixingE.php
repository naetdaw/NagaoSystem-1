...
_________________________________________________________ -->
        ...
        <div id="heading-breadcrumbs">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h2>3次元リアクター(混合活用)Mixing of 3D Ball Mill(3D Reactor)</h2>
                    </div>
                    <div class="col-md-5">
                        <ul class="breadcrumb">
 ...
 _________________________________________________________ -->
                     ...
                     <div class="col-md-9">
                                 ...
                                 <section>
                                    ...
                                    <h2>3D Reactor(Mixed utilization)</h2>
                    </div>
                    <div style="text-align: center;">
                        <a  href="https://www.youtube.com/watch?v=G52dMHI6R7U">
                        <button type="button" class="btn btn-info" style="width: 250px;height: 70px;"> 3D Reactor MOVIE(Ver.1)<br> 3D Reactor MOVIE(Ver.2)
                        </button></a>
                        <a href="https://www.youtube.com/watch?v=HyGXTj_D8Co&feature=youtu.be">
                        <button type="button" class="btn btn-info" style="width: 250px;height: 70px;"> 3D Reactor MOVIE(Ver.5)
                        </button></a>
                        <BR>
                            <BR>
                    </div>
                            <img src="img/product/logo162.jpg" style="width: 800px;height: 500px;
                             text-align: center; border-radius: 25px;
                            border: 3px solid #BEBEBE;
                            padding: 5px; 
                            width: 800px;
                            height: 500px;">
                            <img src="img/product/logo991.jpg" style="width: 900px;height: 500px;
                            text-align: center; border-radius: 25px;
                            border: 3px solid #BEBEBE;
                            padding: 5px; 
                            width: 800px;
                        ...
                        <img src="img/product/logo163.jpg" style="width: 900px;height: 500px;
                         text-align: center; border-radius: 25px;
                         border: 3px solid #BEBEBE;
                         padding: 5px; 
                         width: 800px;
                        ...
                        <img src="img/product/logo301.jpg" style="width: 900px;height: 500px;
                        text-align: center; border-radius: 25px;
                        border: 3px solid #BEBEBE;
                        padding: 5px; 
                        width: 800px;
                        ...
                        <img src="img/product/logo303.jpg" style="width: 900px;height: 500px;
                        text-align: center; border-radius: 25px;
                        border: 3px solid #BEBEBE;
                        padding: 5px; 
                        width: 800px;
