...
High-speed 3D motion can be expected to reduce mixing unevenness and improve milling uniformity.</p>
                        </div>
                    </div>
                    ...
                    <div class="row portfolio">
                        ...
                        <div class="col-sm-8 col-md-4">
                            <div class="box-image">
                                <div class="image">
                                  <div class="video">
                                  <h4> NAVI 3-D Ball Mill (3 D Reactor) </h4>
                                <div class="embed-responsive embed-responsive-4by3">
                        ...
                        <div class="col-sm-8 col-md-4">
                            <div class="box-image">
                                <div class="image">
                                  <div class="video">
                                  <h4>Ball Mill using Natural Energy</h4>
                                <div class="embed-responsive embed-responsive-4by3">
                                    <iframe class="embed-responsive-item" src="//www.youtube.com/embed/a_vF89R-2_w"></iframe>
                                </div>
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-8 col-md-4">
                            <div class="box-image">
                                <div class="image">
                                  <div class="video">
                                  <h4>Health Benefits of Brazil Nuts</h4>
                                <div class="embed-responsive embed-responsive-4by3">
                                    <iframe class="embed-responsive-item" src="//www.youtube.com/embed/q4hIDCudT6Q"></iframe>
                                </div>
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-8 col-md-4">
                         ...
                         <div class="col-sm-8 col-md-4">
                            <div class="box-image">
                                <div class="image">
                                  <div class="video">
                                  <h4>　3D Ball Mill (3D Reactor) Empty Container</h4>
                                <div class="embed-responsive embed-responsive-4by3">
                        ...
                        <div class="col-sm-8 col-md-4">
                            <div class="box-image">
                                <div class="image">
                                  <div class="video">
                                  <h4>Planet M2-3F (Small inclined planetary ball mill)</h4>
                                <div class="embed-responsive embed-responsive-4by3">
                                    <iframe class="embed-responsive-item" src="//www.youtube.com/embed/9_vwDCopA1g"></iframe>
                                </div>
                                </div>
                                </div>
                            </div>
                         ...
                         <div class="col-sm-8 col-md-4">
                            <div class="box-image">
                                <div class="image">
                                  <div class="video">
                                  <h4>3D Ball Mill (3D Reactor) The Brazil Nut Effect</h4>
                                <div class="embed-responsive embed-responsive-4by3">
                                    <iframe class="embed-responsive-item" src="//www.youtube.com/embed/ktA9CjbvDRo"></iframe>
                                </div>
                                </div>
                                </div>
                            </div>
                         ...
                         <div class="col-sm-8 col-md-4">
                            <div class="box-image">
                                <div class="image">
                                  <div class="video">
                                  <h4>　New Value Creation NAVI - Nagao System Co., Ltd.</h4>
                                <div class="embed-responsive embed-responsive-4by3">
                                    <iframe class="embed-responsive-item" src="//www.youtube.com/embed/swgbW6qJBAk"></iframe>
                                </div>
                                </div>
                            ...
                            <div class="box-image">
                                <div class="image">
                                  <div class="video">
                                  <h4>　Nagao System MP4</h4>
                                <video width="320" height="240" controls><source src="img/MP4/nagao-yt-en.MP4" type="video/MP4">Your browser not support Video</video>
                                </div>
                                </div>
                            </div>
                            </div>
