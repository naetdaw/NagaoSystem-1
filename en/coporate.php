...
_________________________________________________________ -->
        ...
        <div id="heading-breadcrumbs">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h1>Coporate Philosophy</h1>
                    </div>
                    <div class="col-md-5">
                        <ul class="breadcrumb">
                            <li><a href="index_en.php">Home</a>
                            </li>
                            <li>Coporate Philosophy</li>
                        </ul>
 ...
 _________________________________________________________ -->
                           ...
                           <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                   ...
                                   <li class="active"><a href="coporate.php">Coporate Philosophy</a></li>
                    ...
                    <section>
                        ...
                        <p style="font-size: 1.4em;" align="center"><b>&nbsp;&nbsp;&nbsp;&nbsp;Encounters with unknown world 3D processing(milling) of materials</b></p>                                                                    
                                      
                        <div id="collapse3a" class="panel-collapse collapse in">
                            <div class="panel-body">
                                    <div class="row">
                                               
                                     <div class="col-md-9" style=" text-align: left; border-radius: 20px;
                            border: 3px solid #BEBEBE;  background-color: #F5F5F5;
                            padding: 5px;
                            height: auto;">
                                    ...
                                    The 3D motion provides also pseudo microgravity and can be applied biological/medical science fields, as well as foodstuffs and pharmaceuticals.</p><br>
