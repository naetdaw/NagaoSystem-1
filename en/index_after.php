                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-5 contact">
                            <p class="hidden-sm hidden-xs">+81-44-954-4486
1-9-30 Katahira Asao-Ward Kawasaki-City Kanagawa-Pref
</p>
                        ...
                        <div class="navbar-collapse collapse" id="navigation">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <div class="yamm-content">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <img src="img/product/logo3D210D2.gif" class="img-responsive hidden-xs" alt="">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <h5>Shortcodes</h5>
                                                        <ul>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <div class="yamm-content">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <img src="img/product/3D_ball_mile.gif" class="img-responsive hidden-xs" alt="">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <h5>Portfolio</h5>
                                                        <ul>
                                ...
                                <li class="dropdown use-yamm yamm-fw">
                                 ...
                                 <li class="dropdown use-yamm yamm-fw">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Partners<b class="caret"></b></a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <div class="yamm-content">
                                                <div class="row">
                ...
                <div class="container">
                    <div class="homepage owl-carousel">
                        ...
                        <div class="item">
                            <div class="row">
                                <div class="col-sm-7">
                                    <img class="img-responsive" src="img/product/logo3D210D2.gif" alt="">
                                </div>
                                <div class="col-sm-5">
                                    <h1>3DB-80</h1>
                                    <ul class="list-style-none">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    ...
                                    <div class="text">
                                        <p class="buttons">
                                            <a href="img/PDF/3D210E.pdf" class="btn btn-template-transparent-primary"><i class="fa fa-link"></i> Read more</a>
                                        </p>
                                    </div>
                                </div>

                                <div class="content">
                                    <h4><a href="img/PDF/3D210E.pdf">3D-210-D2</a></h4>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    <div class="image">
                                        <img src="img/product/logo3D210D2.gif" alt="" class="img-responsive">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="text">
                                        <p class="buttons">
                                            <a href="img/PDF/3DB80E.pdf" class="btn btn-template-transparent-primary"><i class="fa fa-link"></i> Read more</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="content">
                                    <h4><a href="img/PDF/3DB80E.pdf">3DB-80</a></h4>
                                    <p class="intro">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    <div class="image">
                                        <img src="img/product/logo206.gif" alt="" class="img-responsive">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="text">
                                        <p class="buttons">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    <div class="image">
                                        <img src="img/product/logoplanetmin3.gif" alt="" class="img-responsive" style="width: 200px; height: 130px;">
                                    </div>
                                    <div class="bg"></div>
                                    <div class="text">
                                        <p class="buttons">
                                ...
                                <div class="content">
                                    <h4><a href="blog-post.html">Planet M2-3F
                                    </a></h4>
                                        <p class="intro">
                                        Powerful fan air cooling<br>
                                        Manufacturer / seller Nagao system<br>
                                        · Nano milling<br>
                                        · Mechano Chemical<br>
                                        · Mechanical alloying<br>
                                        ·amorphous</p>
                ...
                <section>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                           <div class="heading text-center">
                             ...
                             <p class="lead"> &nbsp; &nbsp; &nbsp;3D Ball Mill (3D reactor) is our proprietary product.
                            High speed 3D action made it possible to develop 
                            new products which was impossible in the past.We 
                            propose a new manufacturing..</p>
                        </div>
                    </div>
                    ...
                    <div class="row portfolio">
                        <div class="col-sm-6">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/product/3D_ball_mile.gif" alt="" class="img-responsive" style="width: 500px;height: 350px;">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                        ...
                        <div class="col-sm-6">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/product/logo3D210D2.gif" alt="" class="img-responsive" style="width: 500px;height: 350px;">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                                    <h3><a href="portfolio-detail.html">Portfolio box-image</a></h3> 
                    ...
                    <div class="row portfolio">
                        <div class="col-sm-6">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/product/logo206.gif" alt="" class="img-responsive" style="width: 500px;height: 350px;">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                                    <h3><a href="portfolio-detail.html">Portfolio box-image</a></h3> 
                        ...
                        <div class="col-sm-6">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/product/logoplanetmin3.gif" alt="" class="img-responsive" style="width: 500px;height: 350px;">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                                    <h3><a href="portfolio-detail.html">Portfolio box-image</a></h3> 
                        ...
                        <div class="col-sm-6">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/product/296.jpg" alt="" class="img-responsive" style="width: 500px;height: 350px;">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                                    <h3><a href="portfolio-detail.html">Portfolio box-image</a></h3> 
                        ...
                        <div class="col-sm-6">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/product/sesamiE.jpg" alt="" class="img-responsive" style="width: 500px;height: 350px;">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                                    <h3><a href="portfolio-detail.html">Portfolio box-image</a></h3> 
                        ...
                        <div class="col-sm-6">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/product/logo302.jpg" alt="" class="img-responsive" style="width: 500px;height: 350px;">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                                    <h3><a href="portfolio-detail.html">Portfolio box-image</a></h3> 
                        ...
                        <div class="col-sm-6">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/product/logo164.jpg" alt="" class="img-responsive" style="width: 500px;height: 350px;">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                                    <h3><a href="portfolio-detail.html">Portfolio box-image</a></h3> 
                        ...
                        <div class="col-sm-6">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/product/issuesE.jpg" alt="" class="img-responsive" style="width: 500px;height: 350px;">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                                    <h3><a href="portfolio-detail.html">Portfolio box-image</a></h3> 
                        ...
                        <div class="col-sm-6">
                            <div class="box-image">
                                <div class="image">
                                    <img src="img/product/logo307.jpg" alt="" class="img-responsive" style="width: 500px;height: 350px;">
                                </div>
                                <div class="bg"></div>
                                <div class="name">
                                    <h3><a href="portfolio-detail.html">Portfolio box-image</a></h3> 
