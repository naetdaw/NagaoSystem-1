...
_________________________________________________________ -->
 ...
 _________________________________________________________ -->
                           ...
                           <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li class="active"><a href="decontamination.php">Decontamination</a>
                                    </li>
                 ...
                 <div id="text-page">
                        ...
                        <!-- /.row -->
    <h4>&nbsp;Decontamination business using 3D Ball Mill(3D Reactor)</h4>
                        ...
                        <div class="col-md-12" style="border:1.5px solid #BEBEBE;box-shadow: 5px 0px 40px rgba(0,0,0, .2);" >
                                ...
                                <p style="width:600px; font-size: 1.2em;">
                                    ★&nbsp;Spring Competition★&nbsp;</p>
                                <p style="width:800px; font-size: 1.2em;">    
                                <a href="http://www.jspm.or.jp/E_index.html" target="_blank">★&nbsp;Powder Powder Metallurgy Association  </a><br>
                                  Reduction of cesium contaminated soil by classification and three-dimensional ball mill<br>
(Material mechanism) Yukiaki Harada, Seiichi Kato, (Nagao system) Daisuke Nagao<br>
                                    <b>(Presentation date May 27, 2013)</b></p>
                                     <hr>

                                    <p style="font-size:1.2em;">
                                    ★&nbsp;Three-dimensional ball mill was 
                                    <a href="http://www.sntt.or.jp/index_en.html" target="_blank">used
                                   Unexplored science and technology association</a><br>
                                    Special lecture cooperation NIMS
  Removal of cesium from soil by ball mill method
Remove cesium from soil at room temperature, chemical chemicals<br>
                                        <b>(Presentation date January 11, 2013)</b>
                                    </p>
                                    <hr>
