                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-5 contact">
                           <p class="hidden-sm hidden-xs"><font size="5"><b>Nagao System Inc.
                           </b></font>
                            </p>
...
_________________________________________________________ -->
        ...
        <div id="branner-breadcrumbs">
            <div class="container">
                <div class="row">
                <img src="img/branner_contact.png" style="width: 1200px;height: 420px;">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <form name="form1" method="post" action="checkcontact.php" class="contact-form"  onSubmit="JavaScript:return fncSubmit();">
                                <div class="row">
                                     <table name="form1" class="lead" width="100%" id="contact">
                                        <tr>
                                            <th>Company Name</th>
                                            <td><input type="text" class="form-control" id="company" name="company"  placeholder="your company name"  onKeyUp="if(!(isNaN(this.value))) { alert('Please enter the message'); this.value='';}" style="width: 600px; height: 35px;"/><br></td>
                                        </tr>
                                        <tr>
                                            <th>Your Name</th>
                                            <td><input type="text" class="form-control" id="name" name="name"  placeholder="A person in charge"  onKeyUp="if(!(isNaN(this.value))) { alert('Please enter the message'); this.value='';}" style="width: 600px; height: 35px;"/><br></td>
                                        </tr>
                                        <tr>
                                            <th>Phone Number</th>
                                            <td><input type="text" class="form-control" id="phone" name="phone"  placeholder="phone number" style="width: 600px; height: 35px;"><br></td>
                                        </tr>
                                        <tr>
                                            <th>Content of inquiry</th>
                                            <td><textarea id="Content" class="form-control" name="Content"  placeholder="Content of inquiry" style="width: 600px; height: 150px;"></textarea><br></td>
                                        </tr>
                                    </table>
                    ...
                    <div class="col-md-4">
                        ...
                        <section>
                            <h3 class="text-uppercase">Address</h3>
                                <p>1-9-30 Katahira Asao-Ward Kawasaki-City 
                                 <br>Kanagawa-Pref
                                <br>215-0023
                                <br>JAPAN
                                <br>
...
<html>
   ...
   <head>
      ...
      <script>
         function loadMap() {  //โหลดแผนที่
            
            var mapOptions = {
               center:new google.maps.LatLng(35.590474, 139.498737),//position area
               zoom:18 //ซูมระยะแผนที่
            }
            
            var map = new google.maps.Map(document.getElementById("sample"),mapOptions);
            
            var marker = new google.maps.Marker({
               position: new google.maps.LatLng(35.590474, 139.498737),//position area
               map: map,
               draggable:true,
            ...
            var infowindow = new google.maps.InfoWindow({ //จัดภาพ ข้อมูล
           content:'<IMG BORDER="0" ALIGN="right" SRC="img/path1.jpg" height="50" width="55" > Nagao  System  INC,  1-9-30  Kamiasao  Asao-Ward  Kawasaki-City Kanagawa-Pref, 215-0023 JAPAN',
           maxWidth:250
            });
   ...
   <body onload = "loadMap()"> 
      <div id = "sample" style = "width:1500px; height:400px;"></div>  
   </body>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDXiAZ4SzEBwXxVMACA2ICxnRYBRYhfHjQ&callback=initMap"> //key api google map
    </script>
</html>
        </div>
