...
_________________________________________________________ -->
        ...
        <div id="heading-breadcrumbs">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h2>3D Ball Mill Newspaper Articles</h2>
                    </div>
                    <div class="col-md-5">
                        <ul class="breadcrumb">
 ...
 _________________________________________________________ -->
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="decontamination.php">Decontamination</a>
                                     ...
                                     <li class="active"><a href="news.php">Newspaper Articles</a>
                                    </li>
                                    <li><a href="wanted.php">Partner</a>
                                    </li>
                 ...
                 <div id="text-page">
                        ...
                        <p class="text-muted text-uppercase mb-small text-right">By <a href="#">Nagao System</a> |  December 18, 2009</p>
                                <h2>3D Ball Mil(3D Reactor)l introduction article</h2>
                           
                                <blockquote>
                                <ul>
                                    <li style="font-size:1.2em;">Nihon Keizai Newspaper</li>
                                    <li style="font-size:1.2em;" >Asahi Newspaper</li>
                                    <li style="font-size:1.2em;">Nikkan Kogyo Newspaper</li>
                                </ul>
                                </blockquote>
