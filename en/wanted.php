                 ...
                 <div class="panel panel-default sidebar-menu with-icons">
                      ...
                      <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li class="active"><a href="wanted.php">Partner</a>
                                    </li>
                    ...
                    <div class="col-md-9">
                      <div id="text-page"  >
                               ...
                               <ul>
                                    <li style="font-size:1.4em;">Agent, Representative</li>
                                    <li style="font-size:1.4em;" >Dealer,Distributor</li>
                            ...
                            <div class="panel-group accordion" id="accordionThree">
                                ...
                                [ Hope trading company, agency]</a>
                                    ...
                                    <div id="collapse3a" class="panel-collapse collapse in">
                                        ...
                                        <div class="col-md-9">
                                       <p style="font-size: 1.2em; width:700px;">★&nbsp;&nbsp;Agent with a sales channel of a pharmaceutical manufacturer</p>
                                       <p style="font-size: 1.2em; width:700px;">★&nbsp;&nbsp;Agent with a sales channel of cosmetic manufacturers.</p>
                                      <p style="font-size: 1.2em; width:700px;">★&nbsp;&nbsp;Agents with sales channels of biomakers.</p>
                                       <p style="font-size: 1.2em; width:700px;">★&nbsp;&nbsp;Supplements, agents with sales channels of health food manufacturers.</p>
                                      <p style="font-size: 1.2em; width:700px;">★&nbsp;&nbsp; Agents with sales channels of universities, public institutions, research institutes.</p>
                                      <p style="font-size: 1.2em; width:700px;">★&nbsp;&nbsp;Agent with sales channel of chemical manufacturers.</p>
                                      <p style="font-size: 1.2em; width:700px;">★&nbsp;&nbsp;Agents with sales channels of inorganic material manufacturers.</p>
                                      <p style="font-size: 1.2em; width:700px;">★&nbsp;&nbsp;Agent with sales channel of 3D model material manufacturer.</p>
                                      <p style="font-size: 1.2em; width:700px;">★&nbsp;&nbsp;Electronics material (conductive material paste & ink) agent with sales channel of manufacturer.</p>
                                      <p style="font-size: 1.2em; width:700px;">★&nbsp;&nbsp;Agents with ink, paint-like sales channels.</p>
                                      <p style="font-size: 1.2em; width:700px;">★&nbsp;&nbsp;An agent with a sales channel of a pharmaceutical manufacturer.</p>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapse3a" class="panel-collapse collapse in">
                                        <div class="panel-body">
                                            <div class="row">
                                               <div class="col-md-9">
                                            <img src="img/profile/logo133.jpg" width="650" height="350">
